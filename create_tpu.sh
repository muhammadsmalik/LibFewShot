...
for instance in ocd3-2 ocd3-3 ocd3-4 ocd3-5; do
  attempt=0
  ...
  while true; do
    ...
    gcloud compute tpus tpu-vm create "$instance" --zone=europe-west4-a --accelerator-type=v3-8 --version=tpu-vm-pt-2.0
