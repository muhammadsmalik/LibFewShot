...
if __name__ == "__main__":
    ...
    nameCollection=["Baseline++_10_resnet18_1","Baseline++_10_Conv32F_1"]

    modelCollection=["Baseline++","Baseline++"]

    numShotsCollection=["10","10"]

    backboneCollection=["resnet18","Conv32F"]
